...
image:
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build github.com/Arkelenia/gapic-generator-go/cmd/protoc-gen-go_gapic
	docker build -t gcr.io/gapic-images/gapic-generator-go .
	rm protoc-gen-go_gapic

test-go-cli:
	go test github.com/Arkelenia/gapic-generator-go/internal/gencli
	./cmd/protoc-gen-go_cli/test.sh

test-gapic:
	go test github.com/Arkelenia/gapic-generator-go/internal/gengapic

golden:
	go test github.com/Arkelenia/gapic-generator-go/internal/gengapic -update_golden
